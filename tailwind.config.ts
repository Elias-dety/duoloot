    ...
    extend: {
      colors: {
        ...
        surface: {
          ...
          elevated: withOpacity("--dl-surface-rgb"),
          hover: withOpacity("--dl-surface-rgb"),
          highlight: withOpacity("--dl-surface-rgb"),
        },
        content: {
        ...
        success: withOpacity("--dl-red-soft-rgb"),
        warning: withOpacity("--dl-muted-light-rgb"),
        error: withOpacity("--dl-red-rgb"),
        danger: withOpacity("--dl-red-dark-rgb"),
        info: withOpacity("--dl-muted-light-rgb"),
        premium: withOpacity("--dl-red-dark-rgb"),
        prize: withOpacity("--dl-red-soft-rgb"),
        accent: {
