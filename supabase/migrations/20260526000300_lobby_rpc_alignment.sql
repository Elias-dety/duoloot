-- Duo Loot lobby RPC alignment
-- Keeps GitHub migrations aligned with the current Supabase schema.
-- Safe patch: no table drops and no data deletion.
-- Current production shape:
--   lobbies.status is public.lobby_status enum.
--   lobby_members primary key is (lobby_id, player_id).
--   lobby_members.player_id and lobby_members.joined_at are required.
