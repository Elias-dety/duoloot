  ...
  return (
    <div className="dl-grid-bg flex min-h-screen flex-col bg-[var(--dl-black)]">
      <header className="sticky top-0 z-20 border-b border-[var(--dl-border)] bg-[rgba(8,10,14,0.9)] backdrop-blur-[14px]">
        <div className="mx-auto flex max-w-[2560px] 3xl:px-12 4xl:px-24 flex-col gap-4 px-3 py-4 md:flex-row md:items-center md:justify-between md:px-6">
      ...
      <main className="relative flex-1">
        <div className="relative z-[1] mx-auto max-w-[2560px] 3xl:px-12 4xl:px-24 px-3 py-6 md:px-6 md:py-8">
          <Outlet />
        </div>
      </main>
    </div>
