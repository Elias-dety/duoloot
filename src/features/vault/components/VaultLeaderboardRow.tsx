    ...
    >
      <div className="flex items-start gap-4">
        <div className="flex min-w-[52px] flex-col items-center gap-2">
          <div
            className={[
              'flex h-11 w-11 items-center justify-center font-[Rajdhani] text-2xl font-bold [clip-path:var(--dl-cut-button)]',
              entry.rankPosition <= 3
                ? 'bg-[rgba(255,226,102,0.12)] text-[var(--dl-tactical-yellow)]'
                : 'bg-[var(--dl-tactical-metal)] text-[var(--dl-tactical-blue)]',
            ].join(' ')}
          >
            #{entry.rankPosition}
          </div>
          {entry.rankPosition === 1 && <Crown className="h-4 w-4 text-[var(--dl-tactical-yellow)]" />}
        </div>
        ...
        <div className="flex min-w-0 flex-1 items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mb-3 flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] font-bold uppercase tracking-wide">
              <span className="text-[var(--dl-tactical-blue)]">{currentRank}</span>
              <span className="text-[var(--dl-tactical-muted)]">{entry.playerName || 'Operador Duo Loot'}</span>
            </div>

            <div className="grid grid-cols-2 gap-2 text-[11px] sm:grid-cols-4">
              <div className="rounded border border-[var(--dl-tactical-line)] bg-[var(--dl-tactical-metal)] px-2 py-2">
                ...
                <p className="font-['Rajdhani'] text-xl font-bold text-[var(--dl-tactical-yellow)]">{points}</p>
              </div>

              <div className="rounded border border-[var(--dl-tactical-line)] bg-[var(--dl-tactical-metal)] px-2 py-2">
                <div className="mb-1 flex items-center gap-1 text-[var(--dl-tactical-green)]">
                  <Target className="h-3.5 w-3.5" />
                  <span className="font-bold uppercase">Missões</span>
                </div>
                <p className="font-['Rajdhani'] text-xl font-bold text-[var(--dl-tactical-green)]">
                  {missionsCompleted}
              ...
              <div className="rounded border border-[var(--dl-tactical-line)] bg-[var(--dl-tactical-metal)] px-2 py-2">
                ...
                <p className="font-['Rajdhani'] text-xl font-bold text-[var(--dl-tactical-blue)]">{trustScore}</p>
              </div>

              <div className="rounded border border-[var(--dl-tactical-line)] bg-[var(--dl-tactical-metal)] px-2 py-2">
                <p className="mb-1 font-bold uppercase text-[var(--dl-tactical-muted)]">Entrada</p>
