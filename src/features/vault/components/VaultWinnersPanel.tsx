  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-3 border-b border-[var(--dl-tactical-line)] pb-4">
        <h2 className="font-['Rajdhani'] text-xl font-bold uppercase text-[var(--dl-tactical-text)]">Arquivo de vencedores</h2>
        <span
      ...
      <div className="dl-panel p-5" style={{ borderColor: 'rgba(168,85,247,0.25)' }}>
        {isLoading ? (
          ...
          <div className="rounded border border-[rgba(255,51,102,0.35)] bg-[rgba(255,51,102,0.08)] p-5 text-center">
            ...
            <p className="font-['Rajdhani'] text-lg font-bold uppercase text-[var(--dl-tactical-red)]">Falha ao carregar vencedores</p>
