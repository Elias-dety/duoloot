  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-3 border-b border-[var(--dl-border)] pb-4">
        <h2 className="font-['Rajdhani'] text-xl font-bold uppercase text-[#ffffff]">
          Vault Ranking
        </h2>
        <span
        ...
        {isLoading ? (
          <div className="space-y-3">
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={index} className="animate-pulse rounded border border-[var(--dl-border)] bg-[var(--dl-surface)] p-4">
          ...
          <div className="rounded border border-[rgba(255,51,102,0.35)] bg-[rgba(255,51,102,0.08)] p-5 text-center">
            ...
            <p className="font-['Rajdhani'] text-lg font-bold uppercase text-[var(--dl-error)]">Falha ao carregar o ranking</p>
